...
class PointResultTest {
    ...
    class RequestCharge {
        ...
        void createByUserAndPayment() {
            ...
            // when
            PointResult.RequestCharge result = PointResult.RequestCharge.from(user, payment);
    ...
    class CancelCharge {
        ...
        void createByUserAndPayment() {
            ...
            // when
            PointResult.CancelCharge result = PointResult.CancelCharge.from(user, payment);
